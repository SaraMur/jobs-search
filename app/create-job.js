...
var _this = this;
var createNewJob = document.getElementById('create-new-job');
var fxEventCreate = function (event) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        data = addJob(requestData);
        console.log('data Result');
        console.log(data);
        return [2 /*return*/];
    });
}); };
createNewJob === null || createNewJob === void 0 ? void 0 : createNewJob.addEventListener('submit', fxEventCreate);
